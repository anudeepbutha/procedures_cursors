...
6. GetWatchHistoryBySubscriber(IN sub_id INT) -- A Stored Procedure that goes through each record in subscriber table and retrieves the watch history of the given subscriber_id by joining the two tables.
